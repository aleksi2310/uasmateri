...
<html lang="en">
  ...
  <div align='center'>
  <h1 style="text-align: center; font-family: sans-serif; color: white;"><marquee>Selamat Datang <?php echo $username;?></marquee></b>
  </div></h1> 
  </div>
  </div>
  </div>
...
<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776; open</span>
  ...
  <h6 style="text-align: center;">SELAMAT MENJELAJAH<br>
